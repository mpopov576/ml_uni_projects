...
1. Each row is a hypothesis - a model that was trained and evaluated.
 The columns are divided into two sets: the first set of columns represent the values of the hyperparameters of the model, the second set: the metrics on the test set. Do not use more than 3 metrics.
